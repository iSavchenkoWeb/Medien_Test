...
6) `php bin/console cache:clear -e prod`
7) run `./vendor/bin/phpunit`, check if no errors on tests

8) If you use linux and apache, execute those commands to set right repository permissions:
